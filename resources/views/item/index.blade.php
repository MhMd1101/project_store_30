				...
				<div class="table100 ver1 m-b-110">
					<table data-vertable="ver1">
						...
						<tbody>
							...
							<tr class="row100">
								<td class="column100 column2" data-column="column2">{{ $item->id }}</td>
								<td class="column100 column3" data-column="column3">{{ $item->name }}</td>
								<td class="column100 column3" data-column="column3">{{ $item->price }}</td>
								<td class="column100 column3" data-column="column3">{{ $item->category_id }}</td>
                                <td class="column100 column4" data-column="column4"><a href="/items/{{ $item->id }}">Show</a>
								<td class="column100 column4" data-column="column4"><a href="/items/{{ $item->id }}/edit">Update</a>
